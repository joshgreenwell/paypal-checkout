...
patchMethod(CheckoutButton, 'render', ({ callOriginal, args : [ props ] }) => {
...
patchMethod(CheckoutButton.props.payment, 'decorate', ({ original, context, args: [ originalPayment ] }) => {
